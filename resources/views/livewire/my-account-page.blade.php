    ...
    <div class="grid md:grid-cols-3 gap-8">
        ...
        <section
            ...
            <div class="space-y-5">
                ...
                <!-- モーダル -->
                @if ($showModal)
                <livewire:modals.edit-field-modal :field="$field" :value="$value" :passkeys="$passkeys"
                    :two-factor-enabled="$twoFactorEnabled" :show2faInput="$show2faInput"
                    :two-factor-code="$twoFactorCode" :qr-code="$qrCode" />
                @endif
        </section>
    </div>
</div>
