            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                <div class="p-4 sm:p-7">
                    <div class="text-center mb-4">
                        <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Reset Passowrd</h1>
                    </div>
                    <!-- Form -->
                    <form wire:submit.prevent="save">
                        @if(session('error'))
                        <div class="mt-2 mb-4 bg-red-500 text-sm text-white rounded-lg p-4" role="alert" tabindex="-1"
