    ...
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          ...
          <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Purchase wide varities of electronics products like
          ...
          <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
            ...
            <div class="py-5">
              <div class="flex space-x-1">
                <svg class="h-4 w-4 text-gray-800 dark:text-gray-200" width="51" height="51" viewBox="0 0 51 51"
